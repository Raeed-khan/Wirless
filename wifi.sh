...
# Yahan se WHILE LOOP shuru hota hai jo script ko baahir jaane se rokega
while true; do
    show_banner
    ...
    echo -e "${CYAN}[5]${NC} Run Local Signal Test (Deauth Analysis)"
    echo -e "${CYAN}[6]${NC} Exit Framework"
    echo ""
    ...
    case $choice in
        1)
            ...
            read -p "Press [Enter] to return to main menu..." # Yeh screen ko rok ke rakhega
            ;;
        2)
